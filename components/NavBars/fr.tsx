...
export default function NavigationBar() {
  ...
  if (!hasMounted) {
    ...
    return  <nav className="border-b-[1px] border-gray-500 sticky top-0 bg-blue-700 z-50">
    <div className="flex items-center text-center w-full">
      ...
      <div className="space-x-[32px] px-[16px] py-4 lexend menu-item md:text-lg lg:text-xl">
        <a className="group hover:underline underline-offset-8 hover:text-2xl ease-out duration-300">
          {t('Navbar_Food')}
          <div className="absolute rounded-3xl -translate-y-[445px] border-[1px] border-gray-500 group-hover:bg-blue-700 group-hover:translate-y-[0px] w-60 h-80 group-hover:block ease duration-700">
            <ul className="py-4">
        ...
        <a className="group hover:underline underline-offset-8 hover:text-2xl ease-out duration-300">
          {t('Navbar_Drinks')}
          <div className="absolute rounded-3xl translate-x-16 -translate-y-[455px] border-[1px] border-gray-500 group-hover:bg-blue-700 group-hover:translate-y-[0px] w-72 h-[400px] group-hover:block ease duration-700">
            <ul className="py-4">
      ...
      <span className="ml-auto inline-flex">
        ...
        <span className="group mx-[16px] ease-out duration-500 h-[20px] w-[20px] inline-flex items-center"><Image width={20} height={20} src={"/world.svg"} alt="languages logo" className="w-10 h-10 hover:w-14 hover:h-14 ease-out duration-500" />
          <div className="-translate-x-40 absolute rounded-3xl -translate-y-[445px] border-[1px] border-gray-500 group-hover:bg-blue-700 group-hover:translate-y-[180px] w-60 h-80 group-hover:block ease duration-700">
