...
export default function NavigationBar() {
    ...
    <div className="flex items-center text-center w-full">
      ...
      <span className="ml-auto inline-flex">
        ...
        <a className="group mx-[16px] ease-out duration-500 h-[20px] w-[20px] inline-flex items-center"><Image width={20} height={20} src={"/world.svg"} alt="languages logo" className="w-10 h-10 hover:w-14 hover:h-14 ease-out duration-500" />
