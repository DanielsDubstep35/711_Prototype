    ...
    <div className="w-screen">
      ...
      <main>
        ...
        <div className="bg-white flex w-full h-[760px]">
          ...
          <div className="px-28 py-16 w-2/5">
            ...
            <div className="">
              <a className="p-2 text-center bg-[#147350] hover:bg-green-600 whitespace-nowrap text-white w-48 h-10 absolute rounded-3xl hover:translate-y-2 ease duration-700">
                View All Promotions
              </a>
            </div>
            <div className="py-32 justify-between flex">
              ...
              <div className="inline-flex border-[1px] active:bg-[#147350] border-gray-500 w-28 h-28"><Image layout="intrinsic" src={"/Images/food3_Offers.png"} alt="Offers3" width={112} height={112} /></div>
            </div>
          </div>
          <div className="bg-[#147350] w-3/5 mx-auto h-full px-60 pt-16 pb-4 text-center">
            <div className="p-2">
              <Image layout="intrinsic" src={"/Images/food1_Offers_big.webp"} alt="Offers1" width={400} height={400} />
            </div>
            <section className="py-2 align-center mx-auto">
              <p className="p-2 text-center bg-yellow-500 whitespace-nowrap m-auto text-white w-48 h-10 ">Only with 7 rewards®</p>
            </section>
        ...
        <div className="bg-black text-white text-right flex font-serif w-full h-[550px]">
          <section className="mx-auto px-16 w-{2/5} h-full">
            <Image layout="intrinsic" src={"/Images/Phone_Rewards.png"} alt="7REWARDS_PHONE" width={550} height={550} />
          </section>
          <section className="mx-auto px-8 py-16 w-{3/5} h-full inline-flex">
            <div className="text-center">
              <p className="lexend text-xl">
                7REWARDS
              </p>
              <p>
                This is tough
              ...
              <section>
                ...
                <p>
                  b double e from ghana
                </p>
                <p>
                  its easy like 123 on the 5
                </p>
              </section>
            </div>
          </section>
